...
const NavBar = () => {
  return (
    <nav className='fixed top-0 left-0 flex justify-between items-center bg-sky-950 w-full py-2 px-4 shadow-sm'>
        <div>
        ...
        <div>        
            <div className="relative">
                ...
                <input type="search" className="block w-full p-2 pl-10 text-white border border-none focus:outline-none bg-sky-900 rounded" placeholder="Busca una canción"/>        
            </div>
        </div>
    </nav>
  )
